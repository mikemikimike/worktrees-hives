...
- Command capability classification consumes wrapper-option operands and aliases fail-closed; shell executors do not collapse nested test or experiment requirements.
